...
## Variable Selection: Traditional vs. Lasso

**Traditional Variable Selection Methods:**

- Theory-driven: Select variables based on domain knowledge
- Correlation checks: Manually remove highly correlated predictors
